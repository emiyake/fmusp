...
export const style = tv({
  slots: {
    ...
    inner: [
      ...
      'block, absolute w-lg h-[2px] bg-neutral-xsoft rounded-[4px]',
      "before:content-[''] before:block before:absolute before:w-lg before:h-[2px] before:bg-neutral-xsoft before:rounded-[4px]",
      'before:top-[-6px] before:opacity:1',
      "after:content-[''] after:block after:absolute after:w-lg after:h-[2px] after:bg-neutral-xsoft after:rounded-[4px]",
      'after:bottom-[-6px]',
