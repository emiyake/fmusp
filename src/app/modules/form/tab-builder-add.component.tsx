...
export const AddElementComponent = (props: AddElementComponentProps) => {
  ...
  return (
    <Tippy
      ...
      render={attrs => (
        <div {...attrs} className="relative z-[9999] w-[280px] max-w-[calc(100vw-16px)]">
          <Card>
            <div className="max-h-[70vh] overflow-auto p-xs">
              <Flex row={false} noGap>
                <Button
                  variant="neutral"
                  link
      ...
      <Button variant="primary" outlined size="sm" onClick={() => setMenuVisible(v => !v)}>
